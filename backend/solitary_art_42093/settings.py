"""
Django settings for solitary_art_42093 project.
...
ROOT_URLCONF = 'solitary_art_42093.urls'
...
WSGI_APPLICATION = 'solitary_art_42093.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_art_42093 API",
    "DESCRIPTION": "API documentation for solitary_art_42093 App",
    "VERSION": "v1",
}
